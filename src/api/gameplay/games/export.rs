//! Builders for the game-export endpoints.
//!
//! Both endpoints can return JSON/NDJSON or PGN depending on the `Accept`
//! header; the builders expose terminal methods for each representation.
